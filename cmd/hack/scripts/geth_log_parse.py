...
with open('/Users/alexeyakhunov/workspace/src/github.com/syncreticcapital/erigon/badger.log') as f:
    lines = f.readlines()
...
with open('/Users/alexeyakhunov/workspace/src/github.com/syncreticcapital/erigon/badger.csv', 'w') as w:
